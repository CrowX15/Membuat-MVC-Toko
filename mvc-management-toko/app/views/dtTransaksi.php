               ...
               <table class="table  table-striped table-hover mt-2 mb-4" border="1">
                    ...
                    <tbody>
                         ...
                         <tr>
                              ...
                              <td>
                                   <a href="index.php?id_trans=<?php echo $transaksi['id_trans']; ?>&action_trs=edit"   class="btn btn-warning btn-sm mx-1">Edit</a>
                                   <a href="index.php?id_trans=<?php echo $transaksi['id_trans']; ?>&action_trs=hapus"  class="btn btn-danger  btn-sm mx-1" onclick="return confirm('Confirmasi : \n Periksa Data Kembali');" >Hapus</a>
                              </td>
                         </tr>
