               ...
               <table class="table  table-striped table-hover mt-2 mb-4" border="1">
                    ...
                    <tbody>
                         ...
                         <tr>
                              ...
                              <td>
                                   <a href="index.php?kd_brg=<?php echo $barang['kd_brg']; ?>&action_brg=edit"   class="btn btn-warning btn-sm mx-1">Edit</a>
                                   <a href="index.php?kd_brg=<?php echo $barang['kd_brg']; ?>&action_brg=hapus"  class="btn btn-danger  btn-sm mx-1" onclick="return confirm('Cek Kembali Sebelum dihapus ');" >Hapus</a>
                              </td>
                         </tr>
